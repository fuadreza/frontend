<template>
      ...
      <div class="flex flex-col lg:flex-row items-center justify-between py-12 lg:py-24 gap-12">
        ...
        <div class="flex-1 text-center lg:text-left space-y-8">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            ...
            <button class="w-full sm:w-auto px-8 py-4 bg-white text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 rounded-full font-semibold text-lg hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-800 hover:border-gray-300 dark:border-gray-600 transition-all duration-300 flex items-center justify-center gap-2 group">
  ...
  <section class="py-16 bg-gray-50 dark:bg-gray-800 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
  ...
  <section class="pb-16 bg-gray-50 dark:bg-gray-800 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div class="bg-white dark:bg-gray-800 rounded-3xl p-8 sm:p-12 shadow-2xl border border-gray-100">
        <div class="text-center max-w-3xl mx-auto mb-16">
          <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
